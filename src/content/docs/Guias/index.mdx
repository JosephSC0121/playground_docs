...
title: Guias
---
Our Guias section offers in-depth tutorials and instructions on various features and best practices. Explore these guides to enhance your knowledge and make the most out of your documentation setup.

- [Authoring Content in Markdown](./guias/create-user): Learn how to author content using Markdown.
- [Authoring Content in MDX](./authoring-content-in-md.mdx): Discover how to use MDX for more dynamic content.
